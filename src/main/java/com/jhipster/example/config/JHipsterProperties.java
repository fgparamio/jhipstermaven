...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "JHipsterMaven@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "JHipsterMaven API";

        private String description = "JHipsterMaven API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "JHipsterMaven";
